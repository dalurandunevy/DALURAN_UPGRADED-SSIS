...
def DisplayForm():
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="SIMPLE STUDENT INFORMATION SYSTEM", font=('palatino', 30), fg="yellow", width=600,bg="red")
    ...
    btn_delete.pack(side=TOP, padx=10, pady=10, fill=X)
    btn_exit = Button(LeftViewForm, text="EXIT", font=("Arial",10), command=Exit,bg="pink")
